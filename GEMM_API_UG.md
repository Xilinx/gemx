...
```
  Because in each GEMM kernel, a systolic array is implemented to carry out number of multiplication and acuumulation in on cycle, the equation for calculating l_timeMsAt100pcEff is:
