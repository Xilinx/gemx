...
*/
#ifndef GEMX_API_TEST_H
#define GEMX_API_TEST_H
...
double run_hw_test(std::string l_xclbinFile,  ProgramType *l_program)
{
  ...
  do {
      ...
      switch(l_op0) {
          ...
          case KargsType::OpSpmv: {
              ...
              bool l_opOk = l_spmv.compare(p_TolRel, p_TolAbs, p_Program0, p_Program1, l_spmvArgs);
              l_compareOk = l_compareOk && l_opOk;
              break;
          }                
          #endif
