...
*/
#ifndef GEMX_GEN_GEMM_H
#define GEMX_GEN_GEMM_H 
...
template <typename T>
void gemm_ref(DenseMat<T> & p_A, DenseMat<T> & p_B,  DenseMat<T> & p_C, DenseMat<GEMX_XdataType> & p_X, int32_t p_postScale) {
    ...
    addInstr(
      ...
      bool p_WithGolden
        ...
        if (p_WithGolden) {
          ...
          gemm_ref<GEMX_dataType>(l_matA, l_matB, l_matC, l_matX, p_postScale);
        }
    ...
    addInstrFromFiles(
      ...
      bool p_WithGolden
        ...
        if (l_good) {
          ...
          if (p_WithGolden){
            gemm_ref<GEMX_dataType>(l_matA, l_matB, l_matC, l_matX, l_postScale);
          }
